...
const tools = [
    ...
    },
    {
        ...
        handler: async (args) => {
            return await FileHandlers.writeFile(args.path, args.content, allowedDirectories);
        },
    },
    {
        name: "list_files",
    ...
    },
    {
        ...
        handler: async (args) => {
            return await FileHandlers.searchForFiles(args.rootPath, args.pattern, args.excludePatterns || [], allowedDirectories);
        },
    },
    {
        name: "edit_file",
        ...
        handler: async (args) => {
            return await FileHandlers.editFile(args.path, args.edits, allowedDirectories);
        },
    },
    {
